...
const string  PARTICLE_FLUIDVEL = "getParticleFluidVel";
...
vector<double> Loader::getFluidVelocity2Load( double x, double y, double z){
    vector<double> velocity;

    for( int n = 0; n < 3; n++ ){
        string varName =PARTICLE_FLUIDVEL+dirs[n]+LOAD;
