class Initializer:
    ...
    def __init__(self):
        ...
        self.vel1 = 0.01
        self.fluidVel1 = [0,0,0]
        self.vel2 = 0.00001
        self.fluidVel2 = [0,0,0]
